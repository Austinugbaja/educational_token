...
contract EducationalToken is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    constructor() ERC20("Educational Token", "ET") {
    ...
    {
        require(_msgSender() == app, "Caller not the App");
        scores[user] = score;
    ...
    function resetUsername(address _user, string calldata _username) external 
    {
        require(_msgSender() == app, "Caller not the App");
